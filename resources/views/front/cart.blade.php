...
<div class="breadcrumb-header justify-content-between">
  <div class="my-auto">
    <div class="d-flex">
      <h4 class="content-title mb-0 my-auto">Product Cart</h4>
    </div>
  </div>
</div>
    ...
    <div class="card">
      <div class="card-body">
            ...
            <tbody>
                ...
                <td>
                  <div class="media">
                    <div class="card-aside-img">
                      <img src="{{URL::asset('assets/img/products/product-3.jpg')}}" alt="img" class="h-60 w-60" />
                    </div>
              ...
              <tr>
                <td>
                  <div class="media">
                    <div class="card-aside-img">
                      <img src="{{URL::asset('assets/img/products/product-1.jpg')}}" alt="img" class="h-60 w-60" />
                    </div>
                    <div class="media-body">
                      <div class="card-item-desc mt-0">
              ...
              <tr>
                <td>
                  <div class="media">
                    <div class="card-aside-img">
                      <img src="{{URL::asset('assets/img/products/product-2.jpg')}}" alt="img" class="h-60 w-60" />
                    </div>
                    <div class="media-body">
                      <div class="card-item-desc mt-0">
        ...
        <div class="shopping-cart-footer">
          ...
          <div class="column">
            <a class="btn btn-primary" href="#" data-toast="" data-toast-type="success" data-toast-position="topRight" data-toast-icon="icon-circle-check" data-toast-title="Your cart" data-toast-message="is updated successfully!">
              Update Cart
            </a>
